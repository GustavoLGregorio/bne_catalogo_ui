...
export default function HeaderNavigation() {
  ...
  return (
    <nav className={`fixed top-0 -right-full h-full w-full`} ref={navRef}>
      <div
        className="bg-nav-background-layer h-full w-full"
        onClick={() => emitter.emit("navToggler")}
      >
        <div className="bg-nav-background absolute z-50 h-full w-2/3 px-3">
          ...
          <footer className="font-inter absolute bottom-8 left-0 w-full font-medium">
            <p className="text-center text-[12px]">&copy; ClearLib 2025</p>
          </footer>
        </div>
      </div>
    </nav>
